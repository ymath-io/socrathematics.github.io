...
$('#sec1').on('show.bs.collapse', function (event) {
        ...
        function saveValue(e){
            ...
            localStorage.setItem(document.location+id, val);// Every time the user is writing something, the localStorage's value will override .
        }

        //get the saved value function - return the value of "v" from localStorage.
        function getSavedValue  (v){
            if (!localStorage.getItem(document.location+v)) {
                return "";// You can change this to your default value.
            }
            return localStorage.getItem(document.location+v);
        }
